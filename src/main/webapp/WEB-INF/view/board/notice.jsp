...
<form:form  modelAttribute="boardVO" method="post" action="/TeamProject/board/notice" enctype="multipart/form-data">
		<!-- <div class="errors">
			<ul>
				...
				<c:forEach items="${boardVOList }" var="board">
					 <div class="contentWrapper">
						...
						--><div class="subject box">
								<a href="/TeamProject/board/detail/${board.id }">${board.subject }</a>
						   </div><!--
